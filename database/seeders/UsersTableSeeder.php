...
class UsersTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $master_2 = $this->createUser(UserType::Master, 'Master 2', 'M898438', '09112345679', $admin->id);
        ...
        $agent_2 = $this->createUser(UserType::Agent, 'Agent 2', 'A898738', '09112345675', $master->id, '4Hvqiu7G');
        (new WalletService)->transfer($master, $agent_2, 2 * 100_0000, TransactionName::CreditTransfer);

        $agent_3 = $this->createUser(UserType::Agent, 'Agent 3', 'A898739', '09112345676', $master->id, 'i0Yvb4df');
        (new WalletService)->transfer($master, $agent_3, 2 * 100_0000, TransactionName::CreditTransfer);

        $agent_4 = $this->createUser(UserType::Agent, 'Agent 4', 'A898740', '09112345677', $master_2->id, 'r9Bv51Qh');
        (new WalletService)->transfer($master_2, $agent_4, 2 * 100_000, TransactionName::CreditTransfer);

        $player_1 = $this->createUser(UserType::Player, 'Player 1', 'P000001', '09111111111', $agent_1->id);
        (new WalletService)->transfer($agent_1, $player_1, 30000, TransactionName::CreditTransfer);

        $player2 = $this->createUser(UserType::Player, 'Player3', 'P000003', '09111111113', $agent_1->id);
        (new WalletService)->transfer($agent_1, $player2, 0.00, TransactionName::CreditTransfer);
        $player3 = $this->createUser(UserType::Player, 'Player4', 'P000004', '09111111114', $agent_1->id);
        (new WalletService)->transfer($agent_1, $player3, 0.00, TransactionName::CreditTransfer);
        $player4 = $this->createUser(UserType::Player, 'Player5', 'P000005', '09111111115', $agent_1->id);
