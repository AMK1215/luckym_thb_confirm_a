    ...
    <div class="col-12 col-md-8 mx-auto">
      <div class="card">
        ...
        <div class="card-header pb-0">
          <div class="d-lg-flex">
            <div>
              <h5 class="mb-0">Create New Owner</h5>
        ...
        <div class="card-body">
          <form role="form" method="POST" class="text-start" action="{{ route('admin.owner.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="custom-form-group">
              <label for="title">Owner ID <span class="text-danger">*</span></label>
            ...
            <div class="custom-form-group">
              ...
              <input type="text" name="site_link" class="form-control" value="{{old('site_link')}}">
              @error('site_link')
              <span class="text-danger d-block">*{{ $message }}</span>
              @enderror
            </div>
